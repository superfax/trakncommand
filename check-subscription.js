...
async function checkIds() {
    try {
        ...
        const meRes = await fetch(`https://graph.facebook.com/v24.0/me?access_token=${ACCESS_TOKEN}&fields=id,name`);
        ...
        if (me.id) {
            ...
            const subRes = await fetch(`https://graph.facebook.com/v24.0/${me.id}/subscribed_apps?access_token=${ACCESS_TOKEN}`);
